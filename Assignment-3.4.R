...
colnames(TitanicData) <- c("Pclass","Survived","Name",
...
Title <- barplot(table(TitanicData$Title),
                 ...
                 ylab = "No. of Passangers", col = "Yellow", las =3)
text(Title, 60,table(TitanicData$Title), pos = 3, srt = 90)
...
predM[, c("Name", "Age","Ticket","Cabin", "Embarked")]=0
